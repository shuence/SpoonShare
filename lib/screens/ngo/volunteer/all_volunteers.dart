...
class allVolunteer extends StatefulWidget {
  const allVolunteer({Key? key}) : super(key: key);

  @override
  _allVolunteerState createState() => _allVolunteerState();
}

class _allVolunteerState extends State<allVolunteer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('All Volunteer'),
