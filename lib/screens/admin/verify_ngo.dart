...
class verifyNGO extends StatefulWidget {
  const verifyNGO({Key? key}) : super(key: key);

  @override
  _verifyNGOState createState() => _verifyNGOState();
}
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: () => _verifyNGO(ngoDoc, context),
...
Future<void> _verifyNGO(DocumentSnapshot ngoDoc, BuildContext context) async {
  try {
    await FirebaseFirestore.instance
        .collection('ngos')
        .doc(ngoDoc.id)
        .update({'verified': true});
    showSuccessSnackbar(context, 'ngo verified successfully');
    ...
    showErrorSnackbar(context, 'Error verifying ngo');
  }
}
